    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-20">
            ...
            <motion.div
                ...
                className="bg-gradient-to-br from-blue-600 to-indigo-800 text-white px-6 pt-12 pb-24 rounded-b-[40px] shadow-2xl mb-[-40px] relative overflow-hidden"
            >
                <div className="relative z-10 max-w-4xl mx-auto text-center">
                    ...
                    >
                        Your pocket library for last-minute revision.
                    </motion.p>
                </div>
                ...
                <motion.div
                    ...
                    className="absolute top-[-50px] left-[-50px] w-48 h-48 bg-white/10 rounded-full blur-3xl"
                />
                <motion.div
                    animate={{ y: [0, 10, 0], opacity: [0.2, 0.3, 0.2] }}
                    transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }}
                    className="absolute bottom-[-20px] right-[-20px] w-64 h-64 bg-blue-400/20 rounded-full blur-3xl"
                />
            </motion.div>
            ...
            <div className="max-w-4xl mx-auto px-4 relative z-20">
                            ...
                            {recentNotes.map((note, index) => (
                                ...
                                >
                                    <motion.div
                                        ...
                                        className="bg-white dark:bg-gray-800 p-4 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-all flex flex-col justify-between h-32 active:scale-95 touch-manipulation cursor-pointer"
                                    >
                ...
                <motion.div
                    ...
                    className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700 p-6 md:p-8"
                >
