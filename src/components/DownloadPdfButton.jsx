...
const DownloadPdfButton = ({ contentRef, department, year, subject, title }) => {
  ...
  return (
    <div className="mt-12 pt-6 border-t border-gray-200 dark:border-gray-700 pdf-hide">
      <button
      ...
      <p className="text-xs text-gray-500 mt-2">
        Note: PDF generation happens entirely in your browser. Large notes may take a moment.
      </p>
    </div>
  );
};
